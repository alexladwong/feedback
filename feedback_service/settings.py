"""
Django settings for feedback_service project.
...
SECRET_KEY = 'django-insecure-=d*9si*b5q7a44l_s(j+t-ji+n$yhk^s@#iylcq4)m*z!o^6*5'
...
LOGOUT_REDIRECT_URL = 'feedback_list'




# feedback_service/settings.py
